                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Hesabınız silindiğinde, tüm kaynakları ve verileri de kalıcı olarak silinecektir. Hesabınızı kalıcı olarak silmek istediğinizi onaylamak için lütfen şifrenizi girin.
                            </DialogDescription>
                        </DialogHeader>
